	   ...
	   String[][] strFaqs5 = {
			   {
		   		...
		   		},
		   		{
		   			...
		   			"Frequented addresses are places where you spend the most time, such as home and work. We only access your addresses if the app hears your panic scream. It is mandatory to provide your home address and important to include others. Please be sure to keep your addresses up to date."
		   		},
		   		{
	   ...
	   String[][] strFaqs6 = {
			   {
		   			...
		   			"You do not need a monthly phone plan for One Scream to operate. One Scream requires a data connection in order to report your location to Police in an emergency, this connection can be provided by a pay as you go plan carrier."
		   		},
